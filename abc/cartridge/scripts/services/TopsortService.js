...
var TopsortService = {
    ...
    /**
     * Run sponsored brand auction request
     * @param {Object} auctionData - Sponsored brand auction request data
     * @returns {Object} Auction response
     */
    runSponsoredBrandAuction: function (auctionData) {
        if (!this.getConfig().enabled) {
            return { success: false, error: "Product engagement is disabled" };
        }
        return this.callAPI("/v2/auctions/sponsored-brand", auctionData, topsortMockTypes.runSponsoredBrandAuction);
    },
