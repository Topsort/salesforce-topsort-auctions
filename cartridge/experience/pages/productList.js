...
module.exports.render = function (context, modelIn) {
    ...
    var params = {};
    var parameters = request.httpParameterMap.params.value;
    if(parameters && JSON.parse(parameters).custom){
        params = JSON.parse(JSON.parse(parameters).custom);
    }
    ...
    if (content.category) {
        ...
        model.canonicalUrl = URLUtils.abs('Search-Show', 'cgid', categoryId);
    ...
    model.CurrentPageMetaData = PageRenderHelper.getPageMetaData(page, model.canonicalUrl);
    // Check print yotpo script 
    if(params.printYotpoScript){
        model.printYotpoScript = true;
        model.yotpoAppKey = params.yotpoAppKey;
        model.yotpoStaticContentURL = params.yotpoStaticContentURL;
        model.isCartridgeEnabled = params.isCartridgeEnabled;
        model.isLoyaltyEnabled = params.isLoyaltyEnabled;
        model.yotpoLoyaltyStaticContentURL = params.yotpoLoyaltyStaticContentURL;
